...
export default async function handler(req, res) {
  ...
  // Sanitize username
  const username = user.toLowerCase().replace(/[^a-z0-9_-]/g, "").slice(0, 39);
  ...
  // Skip bot traffic
  const botPatterns = /bot|crawl|spider|slurp|mediapartners|googlebot|bingbot|yahoo|baidu|yandex|facebookexternalhit|twitterbot|linkedinbot|whatsapp|curl|wget|python|java|ruby|go-http/i;
